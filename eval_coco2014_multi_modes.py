...
from openpose_plus.inference.common import measure, read_imgfile
...
def compute_keypoints(model_weights_file, cocoGt, coco_api_dir, coco_data_type, eval_method, epoch_num):
    ...
    for item in imgIds:
        ...
        input_fname = '/home/std/data/mscoco2014/%s/%s'%(coco_data_type,fname)
        print (input_fname)
                ...
                for part in range(18):
                    ...
                    if part_idx == 1:
                        ...
                        if idx.astype(int) == -1:
                            ...
                            keypoints.append(int(x))
                            keypoints.append(int(y))
                            keypoints.append(2)
...
if __name__ == '__main__':
    ...
    annFile = ('/home/std/data/mscoco2014/annotations/%s_%s.json'%( prefix, args.coco_dataType))
    cocoGt = COCO(annFile)
