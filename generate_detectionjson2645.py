...
def main():
    ...
    if args.images.endswith(('.jpg', '.JPG', '.png', '.PNG')):
        ...
        if args.images.endswith('.json'):
            ...
            imgIds_2645 = sorted([int(line.split('_')[-1].lstrip('0').rstrip('.jpg\n')) for line in open('../../validate2645.txt')])
            ...
            if os.path.isdir(args.path_to_npz):
                ...
                for npz_file in list_of_npz:  
                    ...
                    if iteration >= args.iter and iteration%2000 == 0:                        
                        ...
                        #resFile = 'vis_val2017_trained2014_Summary_vgginitlrvariationaddlossAugNesterovresizeshortest_None_Exp12/json_detection_100000.json'
                        ...
                        #coco_eval.params.imgIds = imgIds_2645
                        #coco_eval.evaluate()
                        #coco_eval.accumulate()
                        #coco_eval.summarize()
                        coco_analyze.cocoEval.params.imgIds = imgIds_2645
                        coco_analyze.params.imgIds = imgIds_2645
